...
import { SOURCE_CATALOG, sourceRef } from '../sourceCatalog'
...
const blank = (): Task => ({
  id:`T-${Date.now()}`,title:'',description:'',departmentId:'ops-hq',department:'運営本部',owner:'',assignmentStatus:'未確定',timing:'',dateStatus:'要再確認',publicationStatus:'公開可否未確定',asOf:new Date().toISOString().slice(0,10),conflictingSourceRefs:[],priority:'中',status:'未着手',dependencies:'',sources:[sourceRef('S2',1,1,'low')],risk:'',updatedAt:new Date().toISOString(),
})
